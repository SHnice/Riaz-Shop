  ...
  return (
    <Fragment>
      ...
      <nav className=" w-full z-20 shadow-lg lg:shadow-none bg-white">
        <div className="m-4 md:mb-0 md:mx-12 md:my-6 grid grid-cols-4 lg:grid-cols-3">
          ...
          <div className="col-span-2 lg:hidden flex justify-items-stretch	 items-center">
            ...
            <span
              ...
              className="flex items-left text-center font-bold uppercase text-gray-800 text-l cursor-pointer px-2 text-center"
            >
            Baba Sardaar  
            </span>
          </div>
